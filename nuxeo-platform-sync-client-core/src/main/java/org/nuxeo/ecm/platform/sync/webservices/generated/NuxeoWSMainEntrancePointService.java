...
public class NuxeoWSMainEntrancePointService extends Service {
    ...
    public NuxeoWSMainEntrancePointService() {
        super(NUXEOWSMAINENTRANCEPOINTSERVICE_WSDL_LOCATION, new QName(
                "http://webservices.server.sync.platform.ecm.nuxeo.org/", "NuxeoWSMainEntrancePointService"));
    }

    /**
     * @return returns NuxeoWSMainEntrancePoint
     */
    ...
    public NuxeoWSMainEntrancePoint getNuxeoWSMainEntrancePointPort() {
        return super.getPort(new QName("http://webservices.server.sync.platform.ecm.nuxeo.org/",
                "NuxeoWSMainEntrancePointPort"), NuxeoWSMainEntrancePoint.class);
    }
    ...
    public NuxeoWSMainEntrancePoint getNuxeoWSMainEntrancePointPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.server.sync.platform.ecm.nuxeo.org/",
                "NuxeoWSMainEntrancePointPort"), NuxeoWSMainEntrancePoint.class, features);
    }
